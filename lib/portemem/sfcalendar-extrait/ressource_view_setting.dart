...
class ResourceViewSettingsT with Diagnosticable {
  ...
  bool operator ==(dynamic other) {
    ...
    late final ResourceViewSettingsT otherStyle;
    if (other is ResourceViewSettingsT) {
      otherStyle = other;
    }
