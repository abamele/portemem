...
class SfDataPagerTheme extends InheritedTheme {
  ...
  /// widgets.
  final SfDataPagerThemeDataT data;
  ...
  static SfDataPagerThemeDataT? of(BuildContext context) {
    final SfDataPagerTheme? sfDataPagerTheme =
    context.dependOnInheritedWidgetOfExactType<SfDataPagerTheme>();
    return sfDataPagerTheme?.data ?? SfThemeT.of(context).dataPagerThemeData;
  }
...
@immutable
class SfDataPagerThemeDataT with Diagnosticable {
  /// Create a [SfDataPagerThemeData] that's used to configure a
  /// [SfDataPagerTheme].
  factory SfDataPagerThemeDataT(
    ...
    return SfDataPagerThemeDataT.raw(
        brightness: brightness,
  ...
  const SfDataPagerThemeDataT.raw(
  ...
  SfDataPagerThemeDataT copyWith(
      {Brightness? brightness,
        Color? backgroundColor,
        Color? itemColor,
        TextStyle? itemTextStyle,
  ...
  static SfDataPagerThemeDataT? lerp(
      SfDataPagerThemeDataT? a, SfDataPagerThemeDataT? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    return SfDataPagerThemeDataT(
  ...
  bool operator ==(Object other) {
    ...
    return other is SfDataPagerThemeDataT &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    final SfDataPagerThemeDataT defaultData = SfDataPagerThemeDataT();
