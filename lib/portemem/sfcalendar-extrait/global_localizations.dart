...
///
abstract class SfLocalizationsT {
  ...
  /// }
  ///```
  static const LocalizationsDelegate<SfLocalizationsT> delegate =
  ...
  /// ```
  ///
  static SfLocalizationsT of(BuildContext context) {
    return Localizations.of<SfLocalizationsT>(context, SfLocalizationsT) ??
        const _DefaultLocalizations();
  }
}

class _SfLocalizationDelegates extends LocalizationsDelegate<SfLocalizationsT> {
  ...
  @override
  Future<SfLocalizationsT> load(Locale locale) =>
      _DefaultLocalizations.load(locale);

  @override
  bool shouldReload(LocalizationsDelegate<SfLocalizationsT> old) => false;
}

/// US English strings for the Syncfusion widgets.
class _DefaultLocalizations implements SfLocalizationsT {
  const _DefaultLocalizations();

  @override
  String get noSelectedDateCalendarLabel => 'Seçili Tarih Yok';

  @override
  String get noEventsCalendarLabel => 'Olay Yok';
  ...
  static Future<SfLocalizationsT> load(Locale locale) {
    return SynchronousFuture<SfLocalizationsT>(const _DefaultLocalizations());
  }
