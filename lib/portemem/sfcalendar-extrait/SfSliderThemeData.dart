...
class SfSliderThemeT extends InheritedTheme {
  /// Applies the given theme [data] to [child].
  ///
  /// The [data] and [child] arguments must not be null.
  const SfSliderThemeT({Key? key, required this.data, required this.child})
      : super(key: key, child: child);

  /// Specifies the color and typography values for descendant slider widgets.
  final SfSliderThemeDataT data;
  ...
  static SfSliderThemeDataT of(BuildContext context) {
    final SfSliderThemeT? sliderTheme =
    context.dependOnInheritedWidgetOfExactType<SfSliderThemeT>();
    return sliderTheme?.data ?? SfThemeT.of(context).sliderThemeData;
  }

  @override
  bool updateShouldNotify(SfSliderThemeT oldWidget) => data != oldWidget.data;

  @override
  Widget wrap(BuildContext context, Widget child) {
    final SfSliderThemeT? ancestorTheme =
    context.findAncestorWidgetOfExactType<SfSliderThemeT>();
    return identical(this, ancestorTheme)
        ? child
        : SfSliderThemeT(data: data, child: child);
  }
}
...
@immutable
class SfSliderThemeDataT with Diagnosticable {
  ...
  static SfSliderThemeDataT? lerp(
      SfSliderThemeDataT? a, SfSliderThemeDataT? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    return SfSliderThemeDataT(
        activeTrackHeight:
  ...
  bool operator ==(Object other) {
    ...
    return other is SfSliderThemeDataT &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    final SfSliderThemeDataT defaultData = SfSliderThemeDataT();
