...
///
class SfGaugeThemeT extends InheritedTheme {
  /// Initialize the gauge theme
  const SfGaugeThemeT({Key? key, required this.data, required this.child})
  ...
  /// build context.
  static SfGaugeThemeDataT? of(BuildContext context) {
    final SfGaugeThemeT? sfGaugeTheme =
    context.dependOnInheritedWidgetOfExactType<SfGaugeThemeT>();
    return sfGaugeTheme?.data ?? SfThemeT.of(context).gaugeThemeData;
  }

  @override
  bool updateShouldNotify(SfGaugeThemeT oldWidget) => data != oldWidget.data;

  @override
  Widget wrap(BuildContext context, Widget child) {
    final SfGaugeThemeT? ancestorTheme =
    context.findAncestorWidgetOfExactType<SfGaugeThemeT>();
    return identical(this, ancestorTheme)
        ? child
        : SfGaugeThemeT(data: data, child: child);
  }
}
...
///
@immutable
class SfGaugeThemeDataT with Diagnosticable {
  /// Initialize the gauge theme data
  factory SfGaugeThemeDataT({
  ...
  static SfGaugeThemeDataT? lerp(
      SfGaugeThemeDataT? a, SfGaugeThemeDataT? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    return SfGaugeThemeDataT(
  ...
  bool operator ==(Object other) {
    ...
    return other is SfGaugeThemeDataT &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    final SfGaugeThemeDataT defaultData = SfGaugeThemeDataT();
