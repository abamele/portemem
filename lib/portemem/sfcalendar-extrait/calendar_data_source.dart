...
///  ```
@optionalTypeArgs
abstract class CalendarDataSourceT<T extends Object?>
  ...
  /// }
  /// ```
  List<AppointmentT> getVisibleAppointments(
    ...
    /// rendering on view.
    List<CalendarAppointmentT> calendarAppointments =
    AppointmentHelperT.generateCalendarAppointments(this, calendarTimeZone);

    calendarAppointments = AppointmentHelperT.getVisibleAppointments(
        startDate, endDate, calendarAppointments, calendarTimeZone, false,
        canCreateNewAppointment: false);

    final List<AppointmentT> visibleAppointments = <AppointmentT>[];
  ...
  ///
  /// ```
  AppointmentT? getOccurrenceAppointment(
    ...
    if (patternCalendarAppointment.recurrenceRule == null ||
      ...
      final List<CalendarAppointmentT> occurrenceAppointments =
  ...
  Object? getPatternAppointment(
    ...
    final CalendarAppointmentT occurrenceCalendarAppointment =
  ...
  ///
  /// ```
  T? convertAppointmentToObject(T customData, AppointmentT appointment) => null;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(IterableDiagnostics<CalendarResourceT>(resources)
...
typedef CalendarDataSourceCallback = void Function(
    CalendarDataSourceActionT, List<dynamic>);
...
class CalendarDataSourceChangeNotifier with Diagnosticable {
  ...
  void notifyListeners(CalendarDataSourceActionT type, List<dynamic> data) {
    if (_listeners == null) {
      return;
    }
