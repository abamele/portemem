...
class _TimeSlotWidgetState extends State<TimeSlotWidgetT> {
  ...
  @override
  void didUpdateWidget(TimeSlotWidgetT oldWidget) {
  ...
  void _updateSpecialRegionDetails() {
    ...
    for (int i = 0; i < widget.specialRegion!.length; i++) {
      ...
      double startYPosition = CalendarViewHelperT.getTimeToPosition(
          Duration(
      ...
      double endYPosition = CalendarViewHelperT.getTimeToPosition(
...
class _TimeSlotRenderWidgetT extends MultiChildRenderObjectWidget {
  _TimeSlotRenderWidgetT(
      this.visibleDates,
      this.horizontalLinesCount,
      this.timeIntervalHeight,
      this.timeLabelWidth,
...
class _TimeSlotRenderObject extends CustomCalendarRenderObjectT {
  ...
  void _minMaxExceeds(DateTime minDate, DateTime maxDate, Canvas canvas,
    ...
    AppointmentHelperT.convertToEndTime(visibleDates[visibleDatesCount - 1]);
  ...
  void _drawDisabledDate(DateTime disabledStartDate, DateTime disabledEndDate,
    ...
    DateTimeHelperT.getVisibleDateIndex(visibleDates, disabledStartDate);
    final int endIndex =
    DateTimeHelperT.getVisibleDateIndex(visibleDates, disabledEndDate);
    final double startYPosition = CalendarViewHelperT.getTimeToPosition(
        Duration(
            hours: disabledStartDate.hour, minutes: disabledStartDate.minute),
        timeSlotViewSettings,
        minuteHeight);
    final double endYPosition = CalendarViewHelperT.getTimeToPosition(
