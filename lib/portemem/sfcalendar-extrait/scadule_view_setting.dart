...
class ScheduleViewSettingsT with Diagnosticable {
  ...
  bool operator ==(dynamic other) {
    ...
    late final ScheduleViewSettingsT otherStyle;
    if (other is ScheduleViewSettingsT) {
      otherStyle = other;
    }
