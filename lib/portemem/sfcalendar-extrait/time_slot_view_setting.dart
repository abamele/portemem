...
class TimeSlotViewSettingsT with Diagnosticable {
  ...
  bool operator ==(dynamic other) {
    ...
    late final TimeSlotViewSettingsT otherStyle;
    if (other is TimeSlotViewSettingsT) {
      otherStyle = other;
    }
