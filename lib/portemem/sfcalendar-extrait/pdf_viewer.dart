...
/// }
/// ```
class SfPdfViewerThemeT extends InheritedTheme {
  /// Creates an argument constructor of [SfPdfViewerTheme] class.
  const SfPdfViewerThemeT({Key? key, required this.data, required this.child})
  ...
  /// }
  /// ```
  final SfPdfViewerThemeDataT data;
  ...
  ///
  static SfPdfViewerThemeDataT? of(BuildContext context) {
    final SfPdfViewerThemeT? pdfViewerTheme =
    context.dependOnInheritedWidgetOfExactType<SfPdfViewerThemeT>();
    return pdfViewerTheme?.data ?? SfThemeT.of(context).pdfViewerThemeData;
  }

  @override
  bool updateShouldNotify(SfPdfViewerThemeT oldWidget) => data != oldWidget.data;

  @override
  Widget wrap(BuildContext context, Widget child) {
    final SfPdfViewerThemeT? ancestorTheme =
    context.findAncestorWidgetOfExactType<SfPdfViewerThemeT>();
    return identical(this, ancestorTheme)
        ? child
        : SfPdfViewerThemeT(data: data, child: child);
  }
}
...
/// ```
@immutable
class SfPdfViewerThemeDataT with Diagnosticable {
  /// Creating an argument constructor of SfPdfViewerThemeData class.
  factory SfPdfViewerThemeDataT(
    ...
    return SfPdfViewerThemeDataT.raw(
        brightness: brightness,
  ...
  ///
  const SfPdfViewerThemeDataT.raw({
  ...
  SfPdfViewerThemeDataT copyWith(
      {Brightness? brightness,
        Color? backgroundColor,
        Color? progressBarColor,
        PdfScrollStatusStyle? scrollStatusStyle,
  ...
  static SfPdfViewerThemeDataT? lerp(
      SfPdfViewerThemeDataT? a, SfPdfViewerThemeDataT? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    return SfPdfViewerThemeDataT(
  ...
  bool operator ==(Object other) {
    ...
    return other is SfPdfViewerThemeDataT &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    final SfPdfViewerThemeDataT defaultData = SfPdfViewerThemeDataT();
