...
class RecurrenceHelperT {
  ...
  static bool _isRecurrenceInBetweenSpecificRange(DateTime appointmentDate,
    ...
    DateTimeHelperT.getDateTimeValue(addDuration(appointmentDate, duration));
  ...
  static List<DateTime> _getDailyRecurrenceDateTimeCollection(
    ...
    if (rRule.contains('UNTIL')) {
      ...
      endDate = AppointmentHelperT.addDaysWithTime(
          recurrenceStartDate,
    ...
    if (isSpecificDateRange &&
      ...
      /// start date.
      final int difference = AppointmentHelperT.getDifference(
      ...
      if (dayDifference == 0) {
        ...
        addDate = AppointmentHelperT.addDaysWithTime(
            visibleInitialDate,
            -dayDifference,
            recurrenceStartHour,
            recurrenceStartMinute,
      ...
      if (incrementCount > 0 && !isSameDate(addDate, recurrenceEndDate)) {
        ...
        addDate = AppointmentHelperT.addDaysWithTime(addDate, -intervalCount,
    ...
    while (recurrenceIncrementCount < recurrenceCount ||
      ...
      addDate = AppointmentHelperT.addDaysWithTime(addDate, dailyDayGap,
          recurrenceStartHour, recurrenceStartMinute, recurrenceStartSecond);
  ...
  static List<DateTime> _getWeeklyRecurrenceDateTimeCollection(
    ...
    if (isSpecificDateRange &&
      ...
      /// start date.
      int daysDifference =
          AppointmentHelperT.getDifference(startDate, specificStartDate).inDays;
      final DateTime recurrenceEndDate = addDate.add(recurrenceDuration);
    ...
    while ((tempCount < recurrenceCount && isWeeklySelected) ||
      ...
      addDate = addDate.weekday == DateTime.saturday
          ? AppointmentHelperT.addDaysWithTime(
          addDate,
          ((weeklyWeekGap - 1) * DateTime.daysPerWeek) + 1,
          recurrenceStartHour,
          recurrenceStartMinute,
          recurrenceStartSecond)
          : AppointmentHelperT.addDaysWithTime(addDate, 1, recurrenceStartHour,
  ...
  static List<DateTime> _getMonthlyRecurrenceDateTimeCollection(
    ...
    if (byMonthDay == 'BYMONTHDAY') {
      ...
      if (byMonthDay == -1) {
        monthDate = AppointmentHelperT.getMonthEndDate(addDate).day;
      }
      ...
      while (tempCount < recCount ||
        ...
        monthDate = byMonthDay == -1
            ? AppointmentHelperT.getMonthEndDate(DateTime(yearValue, monthValue))
            .day
            : monthDate;
      ...
      void _updateValidDate() {
        ...
        final DateTime weekStartDate = AppointmentHelperT.addDaysWithTime(
            monthStart,
            -monthStartWeekday,
            recurrenceStartHour,
            recurrenceStartMinute,
  ...
  static List<DateTime> _getYearlyRecurrenceDateTimeCollection(
    ...
    if (byMonthDay == 'BYMONTHDAY') {
      ...
      if (byMonthDay == -1) {
        dayIndex = AppointmentHelperT.getMonthEndDate(
      ...
      final int daysInMonth = DateTimeHelperT.getDateTimeValue(
      ...
      while (tempCount < recCount ||
        ...
        dayIndex = byMonthDay == -1
            ? AppointmentHelperT.getMonthEndDate(
      ...
      void _updateValidNextDate() {
        while (true) {
          ...
          if (bySetPosValue.isNegative) {
            ...
            monthStart = AppointmentHelperT.addDaysWithTime(
                weekStartDate,
                (nthWeek * DateTime.daysPerWeek) + nthWeekDay,
                recurrenceStartHour,
                recurrenceStartMinute,
  ...
  static RecurrencePropertiesT parseRRule(String rRule, DateTime recStartDate) {
    final RecurrencePropertiesT recProp =
    RecurrencePropertiesT(startDate: recStartDate);
    ...
    if (rRule.contains('COUNT')) {
      recProp.recurrenceRange = RecurrenceRangeT.count;
      recProp.recurrenceCount =
      recurCount.isNotEmpty ? int.parse(recurCount) : 0;
    } else if (rRule.contains('UNTIL')) {
      recProp.recurrenceRange = RecurrenceRangeT.endDate;
      recProp.endDate = getUntilEndDate(untilValue);
    } else {
      recProp.recurrenceRange = RecurrenceRangeT.noEndDate;
    }

    recProp.interval = intervalCount.isNotEmpty ? int.parse(intervalCount) : 1;
    if (daily == 'DAILY') {
      recProp.recurrenceType = RecurrenceTypeT.daily;
    } else if (weekly == 'WEEKLY') {
      recProp.recurrenceType = RecurrenceTypeT.weekly;
      ...
      if (weeklyByDayString.contains('SU')) {
        recProp.weekDays.add(WeekDaysT.sunday);
      }
      if (weeklyByDayString.contains('MO')) {
        recProp.weekDays.add(WeekDaysT.monday);
      }

      if (weeklyByDayString.contains('TU')) {
        recProp.weekDays.add(WeekDaysT.tuesday);
      }

      if (weeklyByDayString.contains('WE')) {
        recProp.weekDays.add(WeekDaysT.wednesday);
      }

      if (weeklyByDayString.contains('TH')) {
        recProp.weekDays.add(WeekDaysT.thursday);
      }

      if (weeklyByDayString.contains('FR')) {
        recProp.weekDays.add(WeekDaysT.friday);
      }

      if (weeklyByDayString.contains('SA')) {
        recProp.weekDays.add(WeekDaysT.saturday);
      }
    } else if (monthly == 'MONTHLY') {
      recProp.recurrenceType = RecurrenceTypeT.monthly;
      if (byMonthDay == 'BYMONTHDAY') {
        recProp.week = 0;
        recProp.dayOfMonth =
      ...
      recProp.recurrenceType = RecurrenceTypeT.yearly;
      if (byMonthDay == 'BYMONTHDAY') {
  ...
  static String _getRRuleForDaily(
      int recCount,
      RecurrencePropertiesT recurrenceProperties,
      DateTime startDate,
      DateTime? endDate,
    ...
    String rRule = '';
    if ((recCount > 0 &&
        recurrenceProperties.recurrenceRange == RecurrenceRangeT.count) ||
        recurrenceProperties.recurrenceRange == RecurrenceRangeT.noEndDate ||
        (recurrenceProperties.recurrenceRange == RecurrenceRangeT.endDate &&
      ...
      if (recurrenceProperties.recurrenceRange == RecurrenceRangeT.count) {
        rRule = '$rRule;COUNT=$recCount';
      } else if (recurrenceProperties.recurrenceRange ==
          RecurrenceRangeT.endDate) {
        rRule = RecurrenceHelperT._getUntilRRule(endDate!, rRule);
      }
    }
      ...
      while ((count < recCount &&
        ...
        switch (addDate.weekday) {
          case DateTime.sunday:
            {
              if (recurrenceProperties.weekDays.contains(WeekDaysT.sunday)) {
                dayKey = 'SU,';
                dayCount = su;
              }
          ...
          case DateTime.monday:
            {
              if (recurrenceProperties.weekDays.contains(WeekDaysT.monday)) {
                dayKey = 'MO,';
                dayCount = mo;
              }
          ...
          case DateTime.tuesday:
            {
              if (recurrenceProperties.weekDays.contains(WeekDaysT.tuesday)) {
                dayKey = 'TU,';
                dayCount = tu;
              }
          ...
          case DateTime.wednesday:
            {
              if (recurrenceProperties.weekDays.contains(WeekDaysT.wednesday)) {
                dayKey = 'WE,';
                dayCount = we;
              }
          ...
          case DateTime.thursday:
            {
              if (recurrenceProperties.weekDays.contains(WeekDaysT.thursday)) {
                dayKey = 'TH,';
                dayCount = th;
              }
          ...
          case DateTime.friday:
            {
              if (recurrenceProperties.weekDays.contains(WeekDaysT.friday)) {
                dayKey = 'FR,';
                dayCount = fr;
              }
          ...
          case DateTime.saturday:
            {
              if (recurrenceProperties.weekDays.contains(WeekDaysT.saturday)) {
                dayKey = 'SA';
                dayCount = sa;
              }
        ...
        if (dayKey.isNotEmpty) {
          if (count != 0) {
            ...
            AppointmentHelperT.getDifference(prevDate, addDate);
  ...
  static String _getRRuleForMonthly(
    ...
    if ((recCount > 0 &&
      ...
      if (recurrenceProperties.week == 0) {
        ...
        final DateTime firstDate = DateTimeHelperT.getDateTimeValue(
  ...
  static String generateRRule(RecurrencePropertiesT recurrenceProperties,
    ...
    AppointmentHelperT.getDifference(appStartTime, appEndTime);
    int recCount = 0;
  ...
  static DateTime _getRecurrenceDateForNegativeValue(
    ...
    DateTime? lastDate;
    if (bySetPosCount == -1) {
      lastDate = AppointmentHelperT.getMonthEndDate(date);
