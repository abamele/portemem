...
class SfRangeSelectorThemeT extends InheritedTheme {
  /// Applies the given theme [data] to [child].
  ///
  /// The [data] and [child] arguments must not be null.
  const SfRangeSelectorThemeT(
  ...
  /// )
  /// ```
  final SfRangeSelectorThemeDataT data;
  ...
  static SfRangeSelectorThemeDataT? of(BuildContext context) {
    final SfRangeSelectorThemeT? rangeSelectorTheme =
    context.dependOnInheritedWidgetOfExactType<SfRangeSelectorThemeT>();
    return rangeSelectorTheme?.data ??
        SfThemeT.of(context).rangeSelectorThemeData;
  }

  @override
  bool updateShouldNotify(SfRangeSelectorThemeT oldWidget) =>
      data != oldWidget.data;

  @override
  Widget wrap(BuildContext context, Widget child) {
    final SfRangeSelectorThemeT? ancestorTheme =
    context.findAncestorWidgetOfExactType<SfRangeSelectorThemeT>();
    return identical(this, ancestorTheme)
        ? child
        : SfRangeSelectorThemeT(data: data, child: child);
  }
}
...
class SfRangeSelectorThemeDataT extends SfRangeSliderThemeDataT {
  ...
  factory SfRangeSelectorThemeDataT(
    ...
    return SfRangeSelectorThemeDataT.raw(
        brightness: brightness,
  ...
  const SfRangeSelectorThemeDataT.raw({
  ...
  @override
  SfRangeSelectorThemeDataT copyWith({
    Brightness? brightness,
    double? activeTrackHeight,
    double? inactiveTrackHeight,
    Size? tickSize,
  ...
  static SfRangeSelectorThemeDataT? lerp(
      SfRangeSelectorThemeDataT? a, SfRangeSelectorThemeDataT? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    return SfRangeSelectorThemeDataT(
        activeTrackHeight:
  ...
  bool operator ==(Object other) {
    ...
    return other is SfRangeSelectorThemeDataT &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    final SfRangeSelectorThemeDataT defaultData = SfRangeSelectorThemeDataT();
