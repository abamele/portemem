...
/// }
/// ```
class SfMapsThemeT extends InheritedTheme {
  /// Applies the given theme [data] to [child].
  ///
  /// The [data] and [child] arguments must not be null.
  const SfMapsThemeT({Key? key, required this.data, required this.child})
  ...
  static SfMapsThemeDataT? of(BuildContext context) {
    final SfMapsThemeT? mapsTheme =
    context.dependOnInheritedWidgetOfExactType<SfMapsThemeT>();
    return mapsTheme?.data ?? SfThemeT.of(context).mapsThemeData;
  }

  @override
  bool updateShouldNotify(SfMapsThemeT oldWidget) => data != oldWidget.data;

  @override
  Widget wrap(BuildContext context, Widget child) {
    final SfMapsThemeT? ancestorTheme =
    context.findAncestorWidgetOfExactType<SfMapsThemeT>();
    return identical(this, ancestorTheme)
        ? child
        : SfMapsThemeT(data: data, child: child);
  }
}
...
/// ```
@immutable
class SfMapsThemeDataT with Diagnosticable {
  ...
  static SfMapsThemeDataT? lerp(
      SfMapsThemeDataT? a, SfMapsThemeDataT? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    return SfMapsThemeDataT(
  ...
  bool operator ==(Object other) {
    ...
    return other is SfMapsThemeDataT &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    final SfMapsThemeDataT defaultData = SfMapsThemeDataT();
