...
class _AgendaViewLayoutState extends State<AgendaViewLayoutT> {
  ...
  @override
  void didUpdateWidget(AgendaViewLayoutT oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    if (_children.isEmpty && widget.appointmentBuilder != null) {
      ...
      for (int i = 0; i < appointmentCount; i++) {
        final AppointmentViewT view = _appointmentCollection[i];
        ...
        final CalendarAppointmentDetailsT details = CalendarAppointmentDetailsT(
            widget.selectedDate!,
  ...
  void _updateAppointmentDetails() {
    ...
    for (int i = 0; i < widget.appointments!.length; i++) {
      final CalendarAppointmentT appointment = widget.appointments![i];
      ...
      final double appointmentHeight =
          (appointment.isAllDay || isSpanned) && !isLargerScheduleUI
              ...
              : agendaItemHeight;
      final Rect rect =
          Rect.fromLTWH(padding, yPosition, 325 - (2 * padding), 200);
...
class _AgendaViewRenderWidget extends MultiChildRenderObjectWidget {
  ...
  @override
  _AgendaViewRenderObjectT createRenderObject(BuildContext context) {
    return _AgendaViewRenderObjectT(
        monthViewSettings,
  ...
  void updateRenderObject(
      BuildContext context, _AgendaViewRenderObjectT renderObject) {
    renderObject
...
class _AgendaViewRenderObjectT extends CustomCalendarRenderObjectT {
  _AgendaViewRenderObjectT(
  ...
  MonthViewSettingsT? _monthViewSettings;

  MonthViewSettingsT? get monthViewSettings => _monthViewSettings;

  set monthViewSettings(MonthViewSettingsT? value) {
  ...
  ScheduleViewSettingsT? _scheduleViewSettings;

  ScheduleViewSettingsT? get scheduleViewSettings => _scheduleViewSettings;

  set scheduleViewSettings(ScheduleViewSettingsT? value) {
  ...
  List<CalendarAppointmentT>? _appointments;

  List<CalendarAppointmentT>? get appointments => _appointments;

  set appointments(List<CalendarAppointmentT>? value) {
  ...
  List<AppointmentViewT> _appointmentCollection;

  List<AppointmentViewT> get appointmentCollection => _appointmentCollection;

  set appointmentCollection(List<AppointmentViewT> value) {
  ...
  ValueNotifier<ScheduleViewHoveringDetailsT?> _agendaViewNotifier;

  ValueNotifier<ScheduleViewHoveringDetailsT?> get agendaViewNotifier =>
      _agendaViewNotifier;

  set agendaViewNotifier(ValueNotifier<ScheduleViewHoveringDetailsT?> value) {
  ...
  void _drawDefaultUI(Canvas canvas, bool isLargerScheduleUI, Offset offset) {
    ...
    for (int i = 0; i < appointmentCollection.length; i++) {
      ...
      final TextSpan span = TextSpan(
        text:
            'Başlangıç Tarihi: ${DateFormat("dd/MM/yyyy HH:mm").format(appointment.startTime)}\n\nBitiş Tarihi:${DateFormat("dd/MM/yyyy HH:mm").format(appointment.endTime)}\n\nAçıklama: ${appointment.subject}',
...
/*  double _drawIcon(
  ...
  List<double> _drawSpanningAppointmentForScheduleView(
      ...
      Radius cornerRadius) {
    final TextSpan span = TextSpan(
        text: AppointmentHelperT.getSpanAppointmentText(
