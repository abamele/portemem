...
/// }
///  ```
class RecurrencePropertiesT with Diagnosticable {
  /// Creates an recurrence properties .
  ///
  /// An object contains properties that hold data for the creation of
  /// [Appointment.recurrenceRule] for [Appointment] using the
  /// [SfCalendar.generateRRule] method.
  RecurrencePropertiesT(
      {this.recurrenceType = RecurrenceTypeT.daily,
        this.recurrenceCount = 0,
        required this.startDate,
        this.endDate,
        this.interval = 1,
        this.recurrenceRange = RecurrenceRangeT.noEndDate,
        List<WeekDaysT>? weekDays,
        this.week = 0,
        this.dayOfMonth = 1,
        this.dayOfWeek = 1,
        this.month = 1})
      : weekDays = weekDays ?? <WeekDaysT>[],
        assert(recurrenceCount >= 0),
        assert(endDate == null ||
            CalendarViewHelperT.isSameOrBeforeDateTime(endDate, startDate)),
        assert(endDate == null ||
            CalendarViewHelperT.isSameOrAfterDateTime(startDate, endDate)),
        assert(interval >= 1),
  ...
  /// }
  ///  ```
  RecurrenceTypeT recurrenceType;
  ...
  /// }
  ///  ```
  RecurrenceRangeT recurrenceRange;
  ...
  bool operator ==(dynamic other) {
    ...
    late final RecurrencePropertiesT recurrenceProperties;
    if (other is RecurrencePropertiesT) {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
        .add(EnumProperty<RecurrenceTypeT>('recurrenceType', recurrenceType));
    properties
        .add(EnumProperty<RecurrenceRangeT>('recurrenceRange', recurrenceRange));
    properties.add(IterableDiagnostics<WeekDaysT>(weekDays)
