...
/// }
/// ```
class SfDataGridThemeT extends InheritedTheme {
  /// Applies the given theme [data] to [child].
  const SfDataGridThemeT({Key? key, required this.data, required this.child})
  ...
  /// }
  /// ```
  final SfDataGridThemeDataT data;
  ...
  ///
  static SfDataGridThemeDataT of(BuildContext context) {
    final SfDataGridThemeT? sfDataGridTheme =
    context.dependOnInheritedWidgetOfExactType<SfDataGridThemeT>();
    return sfDataGridTheme?.data ?? SfThemeT.of(context).dataGridThemeData;
  }

  @override
  bool updateShouldNotify(SfDataGridThemeT oldWidget) => data != oldWidget.data;

  @override
  Widget wrap(BuildContext context, Widget child) {
    final SfDataGridThemeT? ancestorTheme =
    context.findAncestorWidgetOfExactType<SfDataGridThemeT>();
    return identical(this, ancestorTheme)
        ? child
        : SfDataGridThemeT(data: data, child: child);
  }
}
...
///
@immutable
class SfDataGridThemeDataT with Diagnosticable {
  /// Create a [SfDataGridThemeData] that's used to configure a
  /// [SfDataGridTheme].
  factory SfDataGridThemeDataT({
    ...
    return SfDataGridThemeDataT.raw(
        brightness: brightness,
  ...
  ///
  const SfDataGridThemeDataT.raw(
  ...
  static SfDataGridThemeDataT? lerp(
      SfDataGridThemeDataT? a, SfDataGridThemeDataT? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    return SfDataGridThemeDataT(
  ...
  bool operator ==(Object other) {
    ...
    return other is SfDataGridThemeDataT &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    final SfDataGridThemeDataT defaultData = SfDataGridThemeDataT();
