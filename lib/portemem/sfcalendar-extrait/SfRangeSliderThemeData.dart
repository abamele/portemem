...
class SfRangeSliderThemeT extends InheritedTheme {
  /// Applies the given theme [data] to [child].
  ///
  /// The [data] and [child] arguments must not be null.
  const SfRangeSliderThemeT({Key? key, required this.data, required this.child})
      : super(key: key, child: child);

  /// Specifies the color and typography values for
  /// descendant range slider widgets.
  final SfRangeSliderThemeDataT data;
  ...
  static SfRangeSliderThemeDataT? of(BuildContext context) {
    final SfRangeSliderThemeT? rangeSliderTheme =
    context.dependOnInheritedWidgetOfExactType<SfRangeSliderThemeT>();
    return rangeSliderTheme?.data ?? SfThemeT.of(context).rangeSliderThemeData;
  }

  @override
  bool updateShouldNotify(SfRangeSliderThemeT oldWidget) =>
      data != oldWidget.data;

  @override
  Widget wrap(BuildContext context, Widget child) {
    final SfRangeSliderThemeT? ancestorTheme =
    context.findAncestorWidgetOfExactType<SfRangeSliderThemeT>();
    return identical(this, ancestorTheme)
        ? child
        : SfRangeSliderThemeT(data: data, child: child);
  }
}
...
class SfRangeSliderThemeDataT extends SfSliderThemeDataT {
  ...
  factory SfRangeSliderThemeDataT(
    ...
    return SfRangeSliderThemeDataT.raw(
        brightness: brightness,
  ...
  const SfRangeSliderThemeDataT.raw({
  ...
  @override
  SfRangeSliderThemeDataT copyWith({
    Brightness? brightness,
    double? activeTrackHeight,
    double? inactiveTrackHeight,
    Size? tickSize,
  ...
  static SfRangeSliderThemeDataT? lerp(
      SfRangeSliderThemeDataT? a, SfRangeSliderThemeDataT? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    return SfRangeSliderThemeDataT(
        activeTrackHeight:
  ...
  bool operator ==(Object other) {
    ...
    return other is SfRangeSliderThemeDataT &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    final SfRangeSliderThemeDataT defaultData = SfRangeSliderThemeDataT();
