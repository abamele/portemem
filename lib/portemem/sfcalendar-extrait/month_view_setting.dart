...
class MonthViewSettingsT with Diagnosticable {
  ...
  ///  }
  /// ```
  final MonthAppointmentDisplayModeT appointmentDisplayMode;
  ...
  bool operator ==(dynamic other) {
    ...
    late final MonthViewSettingsT otherSetting;
    if (other is MonthViewSettingsT) {
      otherSetting = other;
    }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(EnumProperty<MonthAppointmentDisplayModeT>(
        'appointmentDisplayMode', appointmentDisplayMode));
    properties.add(EnumProperty<MonthNavigationDirectionT>(
...
class MonthCellStyleT with Diagnosticable {
  ...
  bool operator ==(dynamic other) {
    ...
    late final MonthCellStyleT otherStyle;
    if (other is MonthCellStyleT) {
      otherStyle = other;
    }
