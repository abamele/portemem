...
typedef MessageHandlerT = Future<ByteData?>? Function(ByteData? message);
...
abstract class BinaryMessengerT {
  /// Abstract const constructor. This constructor enables subclasses to provide
  /// const constructors so that they can be used in const expressions.
  const BinaryMessengerT();
  ...
  void setMessageHandler(String channel, MessageHandlerT? handler);
