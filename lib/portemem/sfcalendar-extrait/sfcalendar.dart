...
import 'package:portemem/portemem/sfcalendar-extrait/global_localizations.dart';
...
import 'package:portemem/portemem/sfcalendar-extrait/agenda_view_widget.dart';
...
import 'package:portemem/portemem/sfcalendar-extrait/calendar_header_style.dart';
...
import 'package:portemem/portemem/sfcalendar-extrait/calendar_view.dart';
import 'package:portemem/portemem/sfcalendar-extrait/calendar_view_day.dart';
import 'package:portemem/portemem/sfcalendar-extrait/calendar_view_header.dart';
...
import 'package:portemem/portemem/sfcalendar-extrait/drag_and_drop_setting.dart';
...
import 'package:portemem/portemem/sfcalendar-extrait/reccurence_property.dart';
import 'package:portemem/portemem/sfcalendar-extrait/recurrent_helper.dart';
import 'package:portemem/portemem/sfcalendar-extrait/resource_widget.dart';
...
///  ```
@immutable
class SfCalendarT extends StatefulWidget {
  ...
  SfCalendarT({
    ...
    this.headerStyle = const CalendarHeaderStyleT(),
    this.viewHeaderStyle = const ViewHeaderStyleT(),
    this.timeSlotViewSettings = const TimeSlotViewSettingsT(),
    this.resourceViewSettings = const ResourceViewSettingsT(),
    this.monthViewSettings = const MonthViewSettingsT(),
    DateTime? initialDisplayDate,
    this.initialSelectedDate,
    this.scheduleViewSettings = const ScheduleViewSettingsT(),
    DateTime? minDate,
    DateTime? maxDate,
    ...
    this.viewNavigationMode = ViewNavigationModeT.snap,
    this.allowedViews,
    this.specialRegions,
    this.loadMoreWidgetBuilder,
    this.blackoutDatesTextStyle,
    this.showWeekNumber = false,
    this.weekNumberStyle = const WeekNumberStyleT(),
    ...
    this.dragAndDropSettings = const DragAndDropSettingsT(),
    this.onDragStart,
    this.onDragUpdate,
    this.onDragEnd,
    this.onClick
  ...
  ///
  /// ```
  final LoadMoreWidgetBuilderT? loadMoreWidgetBuilder;
  ...
  ///
  /// ```
  final List<CalendarViewT>? allowedViews;
  ...
  ///  }
  ///  ```
  final MonthCellBuilderT? monthCellBuilder;
  ...
  ///  }
  ///  ```
  final CalendarAppointmentBuilderT? appointmentBuilder;
  ...
  ///  }
  ///  ```
  final TimeRegionBuilderT? timeRegionBuilder;
  ...
  ///  }
  ///  ```
  final ScheduleViewMonthHeaderBuilderT? scheduleViewMonthHeaderBuilder;
  ...
  ///
  ///  ```
  final ScheduleViewSettingsT scheduleViewSettings;
  ...
  ///}
  /// ```
  final CalendarHeaderStyleT headerStyle;
  ...
  ///
  /// ```
  final ViewHeaderStyleT viewHeaderStyle;
  ...
  ///
  /// ```
  final ViewNavigationModeT viewNavigationMode;
  ...
  ///
  /// ```
  final TimeSlotViewSettingsT timeSlotViewSettings;
  ...
  ///
  /// ```
  final ResourceViewSettingsT resourceViewSettings;
  ...
  ///
  /// ```
  final MonthViewSettingsT monthViewSettings;
  ...
  ///
  /// ```
  final ViewChangedCallbackT? onViewChanged;
  ...
  ///
  /// ```
  final CalendarTapCallbackT? onTap;
  ...
  ///
  /// ```
  final CalendarLongPressCallbackT? onLongPress;
  ...
  ///
  /// ```
  final CalendarSelectionChangedCallbackT? onSelectionChanged;
  ...
  ///
  /// ```
  final CalendarDataSourceT? dataSource;
  ...
  ///
  ///  ```
  final List<TimeRegionT>? specialRegions;
  ...
  ///   );
  /// }
  final ResourceViewHeaderBuilderT? resourceViewHeaderBuilder;
  ...
  ///   );
  /// }
  final DragAndDropSettingsT dragAndDropSettings;
  ...
  ///   );
  /// }
  final AppointmentDragStartCallbackT? onDragStart;
  ...
  ///   );
  /// }
  final AppointmentDragUpdateCallbackT? onDragUpdate;
  ...
  ///   );
  /// }
  final AppointmentDragEndCallbackT? onDragEnd;
  ...
  ///}
  /// ```
  final CalendarControllerT? controller;
  ...
  ///
  /// ```
  final AppointmentResizeStartCallbackT? onAppointmentResizeStart;
  ...
  ///
  /// ```
  final AppointmentResizeUpdateCallbackT? onAppointmentResizeUpdate;
  ...
  ///
  /// ```
  final AppointmentResizeEndCallbackT? onAppointmentResizeEnd;
  ...
  static List<DateTime> getRecurrenceDateTimeCollection(
    ...
    assert(specificStartDate == null ||
        ...
        CalendarViewHelperT.isSameOrBeforeDateTime(
            specificEndDate, specificStartDate));
    assert(specificStartDate == null ||
        specificEndDate == null ||
        CalendarViewHelperT.isSameOrAfterDateTime(
            specificStartDate, specificEndDate));
    return RecurrenceHelperT.getRecurrenceDateTimeCollection(
  ...
  ///
  /// ```
  static RecurrencePropertiesT parseRRule(String rRule, DateTime recStartDate) {
    return RecurrenceHelperT.parseRRule(rRule, recStartDate);
  }
  ...
  ///
  /// ```
  static String generateRRule(RecurrencePropertiesT recurrenceProperties,
      DateTime appStartTime, DateTime appEndTime) {
    assert(CalendarViewHelperT.isSameOrBeforeDateTime(appEndTime, appStartTime));
    assert(CalendarViewHelperT.isSameOrAfterDateTime(appStartTime, appEndTime));

    return RecurrenceHelperT.generateRRule(
        recurrenceProperties, appStartTime, appEndTime);
  }

  @override
  // ignore: library_private_types_in_public_api
  _SfCalendarTState createState() => _SfCalendarTState();
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
        .add(DiagnosticsProperty<CalendarControllerT>('controller', controller));
    ...
    properties.add(EnumProperty<CalendarViewT>('view', view));
    properties.add(
    ...
    properties.add(DiagnosticsProperty<ViewNavigationModeT>(
    ...
    properties.add(DiagnosticsProperty<ViewChangedCallbackT>(
        'onViewChanged', onViewChanged));
    properties.add(DiagnosticsProperty<CalendarTapCallbackT>('onTap', onTap));
    properties.add(DiagnosticsProperty<CalendarLongPressCallbackT>(
        'onLongPress', onLongPress));
    properties.add(DiagnosticsProperty<CalendarSelectionChangedCallbackT>(
        'onSelectionChanged', onSelectionChanged));
    properties.add(DiagnosticsProperty<ScheduleViewMonthHeaderBuilderT>(
        'scheduleViewMonthHeaderBuilder', scheduleViewMonthHeaderBuilder));
    properties.add(DiagnosticsProperty<MonthCellBuilderT>(
        'monthCellBuilder', monthCellBuilder));
    properties.add(DiagnosticsProperty<CalendarAppointmentBuilderT>(
        'appointmentBuilder', appointmentBuilder));
    properties.add(DiagnosticsProperty<TimeRegionBuilderT>(
        'timeRegionBuilder', timeRegionBuilder));
    properties.add(DiagnosticsProperty<LoadMoreWidgetBuilderT>(
    ...
    properties.add(IterableDiagnostics<CalendarViewT>(allowedViews)
        .toDiagnosticsNode(name: 'allowedViews'));
    properties.add(IterableDiagnostics<TimeRegionT>(specialRegions)
        .toDiagnosticsNode(name: 'specialRegions'));
    properties.add(DiagnosticsProperty<ResourceViewHeaderBuilderT>(
    ...
    properties.add(DiagnosticsProperty<AppointmentDragStartCallbackT>(
        'onDragStart', onDragStart));
    properties.add(DiagnosticsProperty<AppointmentDragUpdateCallbackT>(
        'onDragUpdate', onDragUpdate));
    properties.add(DiagnosticsProperty<AppointmentDragEndCallbackT>(
        'onDragEnd', onDragEnd));
  }
...
class _SfCalendarTState extends State<SfCalendarT>
    with SingleTickerProviderStateMixin {
  late List<DateTime> _currentViewVisibleDates;
  late DateTime _currentDate;
  DateTime? _selectedDate;
  List<CalendarAppointmentT> _visibleAppointments = <CalendarAppointmentT>[];
  List<AppointmentViewT> _allDayAppointmentViewCollection = <AppointmentViewT>[];
  ...
  late String _locale;
  late SfLocalizationsT _localizations;
  late double _minWidth, _minHeight, _textScaleFactor;
  late SfCalendarThemeDataT _calendarTheme;
  late ValueNotifier<Offset?> _headerHoverNotifier, _resourceHoverNotifier;
  late ValueNotifier<ScheduleViewHoveringDetailsT?> _agendaDateNotifier,
      _agendaViewNotifier;
  ...
  List<CalendarAppointmentT> _appointments = <CalendarAppointmentT>[];
  late CalendarControllerT _controller;
  ...
  List<CalendarResourceT>? _resourceCollection;
  ...
  void initState() {
    ...
    _agendaDateNotifier = ValueNotifier<ScheduleViewHoveringDetailsT?>(null);
    _agendaViewNotifier = ValueNotifier<ScheduleViewHoveringDetailsT?>(null);
    ...
    _resourceHoverNotifier = ValueNotifier<Offset?>(null)
      ..addListener(_updateViewHeaderHover);
    _controller = widget.controller ?? CalendarControllerT();
    ...
    _currentDate = DateTimeHelperT.getDateTimeValue(getValidDate(widget.minDate,
    ...
    _resourceCollection =
        CalendarViewHelperT.cloneList(widget.dataSource?.resources);
    if (_view == CalendarViewT.month && widget.monthViewSettings.showAgenda) {
      _agendaScrollController = ScrollController();
    }

    if (CalendarViewHelperT.isResourceEnabled(widget.dataSource, _view)) {
      _resourcePanelScrollController = ScrollController();
    }

    _controller.addPropertyChangedListener(_calendarValueChangedListener);
    if (_view == CalendarViewT.schedule &&
        CalendarViewHelperT.shouldRaiseViewChangedCallback(
            widget.onViewChanged)) {
      CalendarViewHelperT.raiseViewChangedCallback(
          widget, <DateTime>[_controller.displayDate!]);
    }

    _initScheduleViewProperties();
    _blackoutDates = CalendarViewHelperT.cloneList(widget.blackoutDates);
  ...
  void didChangeDependencies() {
    ...
    // height widget
    _minHeight = 300;
    final SfCalendarThemeDataT calendarThemeData = SfCalendarThemeT.of(context);
    _calendarTheme =
        _getThemeDataValue(calendarThemeData, Theme.of(context).colorScheme);
    ...
    _localizations = SfLocalizationsT.of(context);
  ...
  @override
  void didUpdateWidget(SfCalendarT oldWidget) {
    if (oldWidget.controller != widget.controller) {
      ...
      if (widget.controller != null) {
        ...
        _controller.selectedDate = widget.initialSelectedDate;
        _currentDate = DateTimeHelperT.getDateTimeValue(getValidDate(
    ...
    if (oldWidget.controller == widget.controller &&
      ...
      if (oldWidget.controller!.selectedDate !=
        ...
        final CalendarViewT oldView = _view;
        ...
        if (_view == CalendarViewT.schedule) {
          if (CalendarViewHelperT.shouldRaiseViewChangedCallback(
              widget.onViewChanged)) {
            CalendarViewHelperT.raiseViewChangedCallback(
                widget, <DateTime>[_controller.displayDate!]);
          }
    ...
    if (!CalendarViewHelperT.isDateCollectionEqual(
    ...
    if (!CalendarViewHelperT.isCollectionEqual(
    ...
    if (oldWidget.minDate != widget.minDate ||
      ...
      _currentDate = DateTimeHelperT.getDateTimeValue(
      ...
      if (_view == CalendarViewT.schedule) {
        ...
        if (widget.loadMoreWidgetBuilder != null &&
            _scheduleMinDate != null &&
            _scheduleMaxDate != null) {
          _scheduleMinDate = DateTimeHelperT.getDateTimeValue(
              getValidDate(widget.minDate, widget.maxDate, _scheduleMinDate));
          _scheduleMaxDate = DateTimeHelperT.getDateTimeValue(
  ...
  Widget build(BuildContext context) {
    double height;
    _isRTL = CalendarViewHelperT.isRTLLayout(context);
    return LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
          ...
          _isMobilePlatform =
              CalendarViewHelperT.isMobileLayout(Theme.of(context).platform);
          _useMobilePlatformUI =
              CalendarViewHelperT.isMobileLayoutUI(_minWidth, _isMobilePlatform);
          ...
          if (_view == CalendarViewT.schedule &&
              _actualWidth != null &&
              _useMobilePlatformUI !=
                  CalendarViewHelperT.isMobileLayoutUI(
          ...
          _view == CalendarViewT.month && widget.monthViewSettings.showAgenda
          ...
          return GestureDetector(
            child: Container(
              ...
              child: _view == CalendarViewT.schedule
                  ? widget.loadMoreWidgetBuilder == null
  ...
  /// SfCalendar.
  CalendarDetailsT? _getCalendarDetails(Offset position) {
    if (position.dy < widget.headerHeight) {
      /// Return calendar details while the [getCalendarDetailsAtOffset]
      /// position placed on header.
      return CalendarDetailsT(
          null, _getTappedHeaderDate(), CalendarElementT.header, null);
            ...
            if (position.dy > _minHeight - agendaHeight) {
              ...
              if (_selectedDate != null) {
                currentSelectedDate = isDateWithInDateRange(
                    ...
                    !CalendarViewHelperT.isDateInDateCollection(
              ...
              if (currentSelectedDate == null) {
                return const CalendarDetailsT(
                    null, null, CalendarElementT.agenda, null);
              }
              ...
              return CalendarDetailsT(
                  ...
                  selectedAppointments.isNotEmpty
                      ? CalendarElementT.appointment
                      : CalendarElementT.agenda,
                  null);
            }
          }
      ...
      case CalendarViewT.timelineMonth:
        {
          ...
          CalendarViewHelperT.isResourceEnabled(widget.dataSource, _view);
          ...
          if ((!_isRTL && updatedPosition.dx < resourceViewSize) ||
            ...
            final double viewHeaderHeight =
            CalendarViewHelperT.getViewHeaderHeight(
                widget.viewHeaderHeight, _view);
            final double timeLabelSize = CalendarViewHelperT.getTimeLabelWidth(
            ...
            CalendarViewHelperT.getResourceItemHeight(
                resourceViewSize,
                _minHeight - top,
                widget.resourceViewSettings,
                _resourceCollection!.length);

            final CalendarResourceT resource = _getTappedResource(
            ...
            return CalendarDetailsT(resourceAppointments, null,
                CalendarElementT.resourceHeader, resource);
          }
  ...
  CalendarDetailsT? _getScheduleViewDetails(Offset position) {
    ...
    DateTimeHelperT.getDateTimeValue(addDays(prevDate, 6));
    final DateTime endDate =
    DateTimeHelperT.getDateTimeValue(addDays(startDate, 6));

    /// Get the visible week appointment and split the appointments based on
    /// date.
    final List<CalendarAppointmentT> appointmentCollection =
    AppointmentHelperT.getVisibleAppointments(
    ...
    appointmentCollection.sort(
            (CalendarAppointmentT app1, CalendarAppointmentT app2) =>
            app1.actualStartTime.compareTo(app2.actualStartTime));

    /// Get the collection of appointment collection listed by date.
    final Map<DateTime, List<CalendarAppointmentT>> dateAppointments =
    ...
    CalendarViewHelperT.getScheduleAppointmentHeight(
        null, widget.scheduleViewSettings);
    final double allDayAppointmentHeight =
    CalendarViewHelperT.getScheduleAllDayAppointmentHeight(
        null, widget.scheduleViewSettings);
    ...
    CalendarDetailsT _triggerDisplayDateDetails(DateTime date) {
      if ((!_isRTL && viewPadding >= position.dx) ||
          (_isRTL && _minWidth - viewPadding < position.dx)) {
        /// Return calendar details while the [getCalendarDetailsAtOffset]
        /// position placed on view header in schedule view.
        return CalendarDetailsT(null, date, CalendarElementT.viewHeader, null);
      } else {
        /// Return calendar details while the [getCalendarDetailsAtOffset]
        /// position placed on calendar cell in schedule view.
        return CalendarDetailsT(null, date, CalendarElementT.calendarCell, null);
      }
    }
    ...
    for (int i = 0; i < dateAppointmentKeys.length; i++) {
      ...
      final List<CalendarAppointmentT> currentAppointments =
      ...
      if (topPosition <= yPosition &&
        ...
        currentAppointments.sort(
                (CalendarAppointmentT app1, CalendarAppointmentT app2) =>
                AppointmentHelperT.orderAppointmentsAscending(
        ...
        if ((!_isRTL && viewPadding >= position.dx) ||
          ...
          for (int i = 0; i < currentAppointments.length; i++) {
            final CalendarAppointmentT appointment = currentAppointments[i];
          ...
          return CalendarDetailsT(
              widget.dataSource != null &&
                  !AppointmentHelperT.isCalendarAppointment(
                      widget.dataSource!)
                  ? CalendarViewHelperT.getCustomAppointments(
          ...
          for (int k = 0; k < currentAppointments.length; k++) {
            final CalendarAppointmentT appointment = currentAppointments[k];
            ...
            if (currentYPosition <= yPosition &&
              ...
              final List<CalendarAppointmentT> selectedAppointment =
    ...
    if (_useMobilePlatformUI &&
      ...
      if (topPosition <= yPosition &&
        ...
        /// Return calendar details while the [getCalendarDetailsAtOffset]
        /// position placed on header in schedule view.
        return CalendarDetailsT(null, DateTime(endDate.year, endDate.month),
            CalendarElementT.header, null);
      }
      topPosition += monthHeaderHeight;
    }
  ...
  SfCalendarThemeDataT _getThemeDataValue(
      SfCalendarThemeDataT calendarThemeData, ColorScheme colorScheme) {
    return calendarThemeData.copyWith(
        ...
        trailingDatesTextStyle: calendarThemeData.trailingDatesTextStyle ??
            TextStyle(
                color: colorScheme.onSurface.withOpacity(0.54),
                fontSize: 13,
                fontFamily: 'Roboto'),
        leadingDatesTextStyle: calendarThemeData.leadingDatesTextStyle ??
            TextStyle(
                color: colorScheme.onSurface.withOpacity(0.54),
                fontSize: 13,
                fontFamily: 'Roboto'),
        agendaDayTextStyle: calendarThemeData.agendaDayTextStyle ??
            // ignore: lines_longer_than_80_chars
            TextStyle(color: colorScheme.onSurface.withOpacity(0.54), fontWeight: FontWeight.w500, fontSize: 10, fontFamily: 'Roboto'),
        // ignore: lines_longer_than_80_chars
        agendaDateTextStyle: calendarThemeData.agendaDateTextStyle ?? TextStyle(color: colorScheme.onSurface, fontSize: 18, fontFamily: 'Roboto'),
        // ignore: lines_longer_than_80_chars
        todayTextStyle: calendarThemeData.todayTextStyle ?? TextStyle(color: colorScheme.onPrimary, fontSize: 13, fontFamily: 'Roboto'),
        // ignore: lines_longer_than_80_chars
        headerTextStyle: calendarThemeData.headerTextStyle ?? TextStyle(color: colorScheme.onSurface.withOpacity(0.87), fontSize: 18, fontFamily: 'Roboto'),
        // ignore: lines_longer_than_80_chars
        activeDatesTextStyle: calendarThemeData.activeDatesTextStyle ?? TextStyle(color: colorScheme.onSurface.withOpacity(0.87), fontSize: 13, fontFamily: 'Roboto'),
        // ignore: lines_longer_than_80_chars
        timeTextStyle: calendarThemeData.timeTextStyle ?? TextStyle(color: colorScheme.onSurface.withOpacity(0.54), fontWeight: FontWeight.w500, fontSize: 10),
        // ignore: lines_longer_than_80_chars
        viewHeaderDateTextStyle: calendarThemeData.viewHeaderDateTextStyle ?? TextStyle(color: colorScheme.onSurface.withOpacity(0.87), fontSize: 15, fontWeight: FontWeight.w400, fontFamily: 'Roboto'),
        // ignore: lines_longer_than_80_chars
        viewHeaderDayTextStyle: calendarThemeData.viewHeaderDayTextStyle ?? TextStyle(color: colorScheme.onSurface.withOpacity(0.87), fontSize: 11, fontWeight: FontWeight.w400, fontFamily: 'Roboto'),
        // ignore: lines_longer_than_80_chars
        displayNameTextStyle: calendarThemeData.displayNameTextStyle ?? TextStyle(color: colorScheme.onSurface, fontSize: 10, fontWeight: FontWeight.w500, fontFamily: 'Roboto'),
        // ignore: lines_longer_than_80_chars
        weekNumberTextStyle: calendarThemeData.weekNumberTextStyle ?? TextStyle(color: colorScheme.onSurface.withOpacity(0.87), fontSize: 13, fontFamily: 'Roboto'),
        // ignore: lines_longer_than_80_chars
        timeIndicatorTextStyle: calendarThemeData.timeIndicatorTextStyle ?? TextStyle(color: colorScheme.primary, fontWeight: FontWeight.w500, fontSize: 10));
  }
  ...
  void _getAppointment() {
    _appointments = AppointmentHelperT.generateCalendarAppointments(
  ...
  void _updateVisibleAppointments() async {
    ...
    if (_view != CalendarViewT.schedule) {
      ...
      if (_view == CalendarViewT.month &&
        ...
        viewStartDate = AppointmentHelperT.getMonthStartDate(currentMonthDate);
        viewEndDate = AppointmentHelperT.getMonthEndDate(currentMonthDate);
      }

      final List<CalendarAppointmentT> tempVisibleAppointment =
      // ignore: await_only_futures
      await AppointmentHelperT.getVisibleAppointments(
          viewStartDate,
          viewEndDate,
          _appointments,
          widget.timeZone,
          _view == CalendarViewT.month ||
              CalendarViewHelperT.isTimelineView(_view));
      if (CalendarViewHelperT.isCollectionEqual(
  ...
  void _handleScheduleViewScrolled() {
      ...
      for (int i = 0; i < _forwardWidgetHeights.length; i++) {
        ...
        if (scrolledPosition >= widgetPosition &&
          ...
          if (interSectionPoint != -1 &&
            ...
            date = DateTimeHelperT.getDateTimeValue(addDays(date, 6));
          }

          final DateTime currentViewDate = DateTimeHelperT.getDateTimeValue(
    ...
    if (_agendaScrollController!.hasClients &&
      ...
      if (_agendaScrollController!.position.pixels ==
        ...
        DateTime date = AppointmentHelperT.getMonthStartDate(
        ...
        DateTime date = AppointmentHelperT.getMonthEndDate(
  ...
  void _updateSelectionChangedCallback() {
    if (!CalendarViewHelperT.shouldRaiseCalendarSelectionChangedCallback(
        widget.onSelectionChanged)) {
      return;
    }
    final bool isResourceEnabled =
    CalendarViewHelperT.isResourceEnabled(widget.dataSource, _view);
    CalendarViewHelperT.raiseCalendarSelectionChangedCallback(
        widget,
  ...
  void _calendarValueChangedListener(String property) {
    ...
    if (property == 'selectedDate') {
      if (CalendarViewHelperT.isSameTimeSlot(
          _selectedDate, _controller.selectedDate)) {
        return;
      }
      _updateSelectionChangedCallback();
      ...
      setState(() {
        ...
        SchedulerBinding.instance.addPostFrameCallback((_) {
          ...
          if (currentWidget is CustomCalendarScrollViewT) {
        ...
        } else if (CalendarViewHelperT.isResourceEnabled(
      ...
      case CalendarViewT.timelineMonth:
        {
          if (isSameDate(_currentDate, _controller.displayDate) ||
            ...
            if (_canScrollTimeSlotView &&
              ...
              // ignore: avoid_as
      (_customScrollViewKey.currentWidget! as CustomCalendarScrollViewT)
...
void _updateCurrentVisibleDates() {
  final List<int>? nonWorkingDays = (_view == CalendarViewT.workWeek ||
        _view == CalendarViewT.timelineWorkWeek)
        ? widget.timeSlotViewSettings.nonWorkingDays
        : null;
    final int visibleDatesCount = DateTimeHelperT.getViewDatesCount(
        _view,
        widget.monthViewSettings.numberOfWeeksInView,
    ...
    if (_view == CalendarViewT.timelineMonth) {
      _currentViewVisibleDates =
          DateTimeHelperT.getCurrentMonthDates(_currentViewVisibleDates);
  ...
  void _dataSourceChangedListener(
      CalendarDataSourceActionT type, List<dynamic> data) {
    if (!_timeZoneLoaded || !mounted) {
      return;
    }

    final List<CalendarAppointmentT> visibleAppointmentCollection =
    <CalendarAppointmentT>[];
    ...
    switch (type) {
      case CalendarDataSourceActionT.reset:
        {
          _getAppointment();
          _removeScheduleViewAppointmentDates();
          _loadScheduleViewAppointmentDates(_appointments);
        ...
        break;
      case CalendarDataSourceActionT.add:
        {
          final List<CalendarAppointmentT> collection =
          AppointmentHelperT.generateCalendarAppointments(
          ...
          if (_view != CalendarViewT.schedule) {
            ...
            if (_view == CalendarViewT.month &&
              ...
              _currentViewVisibleDates[visibleDatesCount ~/ 2];
              viewStartDate =
                  AppointmentHelperT.getMonthStartDate(currentMonthDate);
              viewEndDate = AppointmentHelperT.getMonthEndDate(currentMonthDate);
            }
        ...
        break;
      case CalendarDataSourceActionT.remove:
        {
        ...
        break;
      case CalendarDataSourceActionT.addResource:
      case CalendarDataSourceActionT.removeResource:
      case CalendarDataSourceActionT.resetResource:
        {
          if (data is! List<CalendarResourceT>) {
            return;
          }

          final List<CalendarResourceT> resourceCollection = data;
          if (resourceCollection.isNotEmpty) {
            ...
            setState(() {
              ...
              if (CalendarViewHelperT.isTimelineView(_view)) {
                _isNeedLoadMore = true;
              }
            });
          }
  ...
  /// schedule view.
  void _loadScheduleViewAppointmentDates(List<CalendarAppointmentT> collection) {
    ...
    for (int i = 0; i < collection.length; i++) {
      ...
      final CalendarAppointmentT appointment = collection[i];
      final List<DateTime> recursiveExceptionDates = <DateTime>[];
      final Duration difference = AppointmentHelperT.getDifference(
      ...
      if (appointment.recurrenceRule != null &&
        ...
        recursiveDates = RecurrenceHelperT.getRecurrenceDateTimeCollection(
        ...
        if (appointment.recurrenceExceptionDates != null) {
          ...
          i++) {
            recursiveExceptionDates.add(
                AppointmentHelperT.convertTimeToAppointmentTimeZone(
  ...
  void _removeScheduleViewAppointmentDates() {
    ...
    for (int i = 0; i < _previousDates.length; i++) {
      ...
      DateTimeHelperT.getDateTimeValue(addDays(weekStartDate, 6));
  ...
  void _updateVisibleAppointmentCollection(
      List<CalendarAppointmentT> visibleAppointmentCollection) {
    if (_view == CalendarViewT.schedule) {
      SchedulerBinding.instance.addPostFrameCallback((Duration timeStamp) {
        setState(() {
  ...
  DateTime _updateCurrentDate(CalendarViewT view) {
    ...
    if (view == CalendarViewT.schedule) {
    ...
    final bool isMonthView =
        view == CalendarViewT.month || view == CalendarViewT.timelineMonth;
    if (_selectedDate != null &&
        isDateWithInDateRange(
  ...
  void _updateAppointmentView(List<CalendarAppointmentT> allDayAppointments) {
    for (int i = 0; i < allDayAppointments.length; i++) {
      AppointmentViewT appointmentView;
      if (_allDayAppointmentViewCollection.length > i) {
        appointmentView = _allDayAppointmentViewCollection[i];
      } else {
        appointmentView = AppointmentViewT();
  ...
  void _updateAppointmentViewPosition() {
    for (final AppointmentViewT appointmentView
    in _allDayAppointmentViewCollection) {
      if (appointmentView.appointment == null) {
        continue;
      }

      final int startIndex = DateTimeHelperT.getIndex(_currentViewVisibleDates,
          appointmentView.appointment!.actualStartTime);
      final int endIndex = DateTimeHelperT.getIndex(_currentViewVisibleDates,
  ...
  void _updateAppointmentPositionAndMaxPosition(
      List<List<AppointmentViewT>> allDayAppointmentView) {
    for (int i = 0; i < allDayAppointmentView.length; i++) {
      final List<AppointmentViewT> intersectingAppointments =
      allDayAppointmentView[i];
      for (int j = 0; j < intersectingAppointments.length; j++) {
        final AppointmentViewT currentView = intersectingAppointments[j];
        if (currentView.position == -1) {
          currentView.position = 0;
          for (int k = 0; k < j; k++) {
            final AppointmentViewT? intersectView = _getAppointmentOnPosition(
      ...
      if (intersectingAppointments.isNotEmpty) {
        final int maxPosition = intersectingAppointments
            .reduce((AppointmentViewT currentAppView,
            AppointmentViewT nextAppView) =>
        ...
        for (int j = 0; j < intersectingAppointments.length; j++) {
          final AppointmentViewT appointmentView = intersectingAppointments[j];
  ...
  AppointmentViewT? _getAppointmentOnPosition(
      AppointmentViewT? currentView, List<AppointmentViewT>? views) {
    if (currentView == null ||
    ...
    for (final AppointmentViewT view in views) {
  ...
  void _updateIntersectAppointmentViewCollection(
    ...
    for (int i = 0; i < _currentViewVisibleDates.length; i++) {
      ...
      for (int j = 0; j < _allDayAppointmentViewCollection.length; j++) {
        final AppointmentViewT currentView = _allDayAppointmentViewCollection[j];
  ...
  void _updateAllDayAppointment() {
    ...
    AppointmentHelperT.resetAppointmentView(_allDayAppointmentViewCollection);
    ...
    final List<CalendarAppointmentT> allDayAppointments =
    <CalendarAppointmentT>[];
    for (final CalendarAppointmentT appointment in _visibleAppointments) {
    ...
    _allDayAppointmentViewCollection
        .sort((AppointmentViewT app1, AppointmentViewT app2) {
      if (app1.appointment != null && app2.appointment != null) {
        return AppointmentHelperT.getDifference(
    ...
    final List<List<AppointmentViewT>> allDayAppointmentView =
    <List<AppointmentViewT>>[];
  ...
  void _updateAllDayPanelHeight() {
    ...
    if (_allDayAppointmentViewCollection.isNotEmpty) {
      maxPosition = _allDayAppointmentViewCollection
          .reduce(
              (AppointmentViewT currentAppView, AppointmentViewT nextAppView) =>
  ...
  void _updateMouseHoverPosition(
    ...
    if (localPosition.dy < widget.headerHeight) {
      ...
      if (isResourceEnabled &&
          ...
          (CalendarViewHelperT.shouldRaiseCalendarTapCallback(widget.onTap) ||
              CalendarViewHelperT.shouldRaiseCalendarLongPressCallback(
                  widget.onLongPress))) {
      ...
      if (_view != CalendarViewT.month && _view != CalendarViewT.schedule) {
        return;
      }
      ...
      if ((isRTL && localPosition.dx > (_minWidth - dateViewWidth)) ||
        ...
        _agendaDateNotifier.value = ScheduleViewHoveringDetailsT(
        ...
        _agendaViewNotifier.value = ScheduleViewHoveringDetailsT(
            currentDate!, Offset(xPosition, yPosition));
      }
    }
  }
  ...
  DateTime _getMaxAppointmentDate(
      List<CalendarAppointmentT> appointments,
      String? timeZone,
      DateTime maxDate,
    ...
    for (int j = 0; j < appointments.length; j++) {
      final CalendarAppointmentT appointment = appointments[j];
      ...
      RecurrenceHelperT.getRecurrenceDateTimeCollection(
        appointment.recurrenceRule!,
      ...
      final Duration duration = AppointmentHelperT.getDifference(
          appointment.actualStartTime, appointment.actualEndTime);
      for (int k = recursiveDates.length - 1; k >= 0; k--) {
        ...
        if (!isExceptionDate) {
          final DateTime recurrenceEndDate = DateTimeHelperT.getDateTimeValue(
  ...
  bool _isAppointmentBetweenDates(List<CalendarAppointmentT> appointments,
      DateTime startDate, DateTime endDate, String? timeZone) {
    startDate = AppointmentHelperT.convertToStartTime(startDate);
    endDate = AppointmentHelperT.convertToEndTime(endDate);
    if (appointments.isEmpty) {
      return false;
    }
    ...
    for (int j = 0; j < appointments.length; j++) {
      ...
      if (appointment.recurrenceRule == null ||
          appointment.recurrenceRule == '') {
        if (AppointmentHelperT.isAppointmentWithinVisibleDateRange(
      ...
      RecurrenceHelperT.splitRule(rule, ruleSeparator);
      ...
      RecurrenceHelperT.getRecurrenceDateTimeCollection(
          ...
          recurrenceDuration: AppointmentHelperT.getDifference(
              appointment.actualStartTime, appointment.actualEndTime),
          specificStartDate: startDate,
          specificEndDate: endDate);
  ...
  bool _isAllDayAppointmentView(CalendarAppointmentT appointment) {
  ...
  int _getAllDayCount(List<CalendarAppointmentT> appointmentCollection) {
    int allDayCount = 0;
    for (int i = 0; i < appointmentCollection.length; i++) {
      final CalendarAppointmentT appointment = appointmentCollection[i];
  ...
  Map<DateTime, List<CalendarAppointmentT>> _getAppointmentCollectionOnDateBasis(
      List<CalendarAppointmentT> appointmentCollection,
      DateTime startDate,
      DateTime endDate) {
    final Map<DateTime, List<CalendarAppointmentT>> dateAppointments =
    <DateTime, List<CalendarAppointmentT>>{};
    while (startDate.isBefore(endDate) || isSameDate(endDate, startDate)) {
      final List<CalendarAppointmentT> appointmentList = <CalendarAppointmentT>[];
      for (int i = 0; i < appointmentCollection.length; i++) {
        final CalendarAppointmentT appointment = appointmentCollection[i];
      ...
      startDate = DateTimeHelperT.getDateTimeValue(addDays(startDate, 1));
    }
  ...
  Widget? _getItem(BuildContext context, int index, bool isRTL) {
    ...
    if (isLoadMore) {
      ...
      final DateTime viewMinDate = DateTimeHelperT.getDateTimeValue(
      ...
      if (index >= 0) {
        ...
        if (_nextDates.isNotEmpty && index > _nextDates.length - 20) {
          ...
          while (count < 20) {
            for (int i = 1; i <= 100; i++) {
              final DateTime updateDate = DateTimeHelperT.getDateTimeValue(
              ...
              final DateTime weekEndDate =
              DateTimeHelperT.getDateTimeValue(addDays(updateDate, 6));
            ...
            date = DateTimeHelperT.getDateTimeValue(addDays(date, 700));
          }
        }
      }
      ...
      if (index <= 0) {
        ...
        if (_previousDates.isNotEmpty && -index > _previousDates.length - 20) {
          ...
          while (count < 20) {
            for (int i = 1; i <= 100; i++) {
              final DateTime updatedDate = DateTimeHelperT.getDateTimeValue(
                  addDays(date, -i * DateTime.daysPerWeek));
              ...
              final DateTime weekEndDate =
              DateTimeHelperT.getDateTimeValue(addDays(updatedDate, 6));
    ...
    for (int i = 0; i < dateAppointmentKeys.length; i++) {
      final List<CalendarAppointmentT> currentDateAppointment =
      ...
      widgets.add(MouseRegion(
          ...
          child: GestureDetector(
            child: _ScheduleAppointmentView(
                header: CustomPaint(
                    painter: _AgendaDateTimePainterT(
                        currentDate,
                        null,
                        widget.scheduleViewSettings,
                  ...
                  ((!_isRTL && details.localPosition.dx < viewPadding) ||
                      (_isRTL &&
                          details.localPosition.dx >
                              _minWidth - viewPadding))) {
                _controller.view = CalendarViewT.day;
                _controller.displayDate = currentDate;
              }

              if (!CalendarViewHelperT.shouldRaiseCalendarTapCallback(
                  widget.onTap)) {
                return;
              }
            ...
            onLongPressStart: (LongPressStartDetails details) {
              ...
              if (!CalendarViewHelperT.shouldRaiseCalendarLongPressCallback(
                  widget.onLongPress)) {
                return;
              }
  ...
  Widget _getMonthOrWeekHeader(
    ...
    if (isMonthLabel && widget.scheduleViewMonthHeaderBuilder != null) {
      final ScheduleViewMonthHeaderDetailsT details =
      ScheduleViewMonthHeaderDetailsT(
          DateTime(startDate.year, startDate.month),
    ...
    return GestureDetector(
        ...
        onTapUp: (TapUpDetails details) {
          ...
          CalendarViewHelperT.raiseCalendarTapCallback(
              widget,
              DateTime(startDate.year, startDate.month, startDate.day),
              null,
              isMonthLabel
        ...
        onLongPressStart: (LongPressStartDetails details) {
          ...
          CalendarViewHelperT.raiseCalendarLongPressCallback(
              widget,
              DateTime(startDate.year, startDate.month, startDate.day),
              null,
              isMonthLabel
  ...
  void _raiseCallbackForScheduleView(
    ...
    if ((!_isRTL && viewHeaderWidth >= offset.dx) ||
      ...
      for (int i = 0; i < appointments.length; i++) {
        final CalendarAppointmentT appointment = appointments[i];
        currentAppointments.add(appointment);
      }
      ...
      if (isTapCallback) {
        CalendarViewHelperT.raiseCalendarTapCallback(
            ...
            DateTime(currentDate.year, currentDate.month, currentDate.day),
            widget.dataSource != null &&
                !AppointmentHelperT.isCalendarAppointment(widget.dataSource!)
                ? CalendarViewHelperT.getCustomAppointments(
                currentAppointments, widget.dataSource)
                : currentAppointments,
            CalendarElementT.viewHeader,
      ...
      final double itemHeight = CalendarViewHelperT.getScheduleAppointmentHeight(
          null, widget.scheduleViewSettings);
      ...
      for (int k = 0; k < appointments.length; k++) {
        final CalendarAppointmentT appointment = appointments[k];
        final double currentAppointmentHeight =
            (_useMobilePlatformUI && _isAllDayAppointmentView(appointment)
                ? allDayItemHeight
                : itemHeight) +
  ...
  Widget addAgenda(double height, bool isRTL) {
    ...
    final DateTime scheduleDisplayDate = DateTimeHelperT.getDateTimeValue(
    ...
    if (_nextDates.isEmpty) {
      ...
      DateTime date =
      DateTimeHelperT.getDateTimeValue(addDays(scheduleDisplayDate, value));
      int count = 0;
    ...
    if (_nextDates.length < 10 && _previousDates.isNotEmpty) {
      ...
      DateTime viewEndDate = DateTimeHelperT.getDateTimeValue(
      ...
      const double padding = 5;
      Map<DateTime, List<CalendarAppointmentT>> dateAppointments =
      _getAppointmentCollectionOnDateBasis(
      ...
      if (_useMobilePlatformUI) {
        ...
        DateTimeHelperT.getDateTimeValue(addDays(viewStartDate, -1));
        for (int i = 0; i < _nextDates.length; i++) {
      ...
      while (totalHeight < height &&
        ...
        if (totalHeight != 0) {
          ...
          viewEndDate =
              DateTimeHelperT.getDateTimeValue(addDays(currentDate, 6));

          /// Calculate the newly added date appointment height and add
          /// the height to existing appointments height.
          appointmentCollection = AppointmentHelperT.getVisibleAppointments(
              viewStartDate,
              isSameOrBeforeDate(_maxDate, viewEndDate)
                  ? viewEndDate
                  : _maxDate!,
      ...
      if (_nextDates.isNotEmpty && isNewDatesAdded) {
        _headerUpdateNotifier.value = DateTimeHelperT.getDateTimeValue(
    ...
    if (_nextDates.isNotEmpty &&
      ...
      DateTimeHelperT.getDateTimeValue(addDays(viewStartDate, 6));
      if (viewStartDate.isBefore(scheduleDisplayDate) &&
        ...
        final DateTime viewEndDate =
        DateTimeHelperT.getDateTimeValue(addDays(scheduleDisplayDate, -1));
        ...
        while (visibleStartDate.isBefore(scheduleDisplayDate) &&
          ...
          final DateTime viewEndDate =
          DateTimeHelperT.getDateTimeValue(addDays(visibleStartDate, 6));
          ...
          if (appEndDate.isAfter(scheduleDisplayDate) ||
            ...
            appEndDate = DateTimeHelperT.getDateTimeValue(
          ...
          initialScrollPosition += _getInitialScrollPosition(
              ...
              appointmentViewHeight,
              allDayAppointmentHeight);
          visibleStartDate = DateTimeHelperT.getDateTimeValue(
  ...
  Widget addAgendaWithLoadMore(double height, bool isRTL) {
    ...
    final DateTime viewMaxDate = DateTimeHelperT.getDateTimeValue(addDays(
        _maxDate,
    ...
    AppointmentHelperT.getMonthStartDate(scheduleDisplayDate);
    DateTime visibleMaxDate =
    AppointmentHelperT.getMonthEndDate(scheduleDisplayDate);
    ...
    if (_nextDates.isNotEmpty &&
      ...
      while (isSameOrBeforeDate(_maxDate, viewStartDate)) {
        final DateTime viewEndDate = DateTimeHelperT.getDateTimeValue(
        ...
        viewStartDate = DateTimeHelperT.getDateTimeValue(
      ...
      for (int i = 0; i < _nextDates.length; i++) {
        ...
        final DateTime visibleEndDate = DateTimeHelperT.getDateTimeValue(
            addDays(visibleStartDate, DateTime.daysPerWeek));
        if (!isDateWithInDateRange(
    ...
    if (isInitialLoadMore) {
      _isNeedLoadMore = true;
      _scheduleMaxDate = AppointmentHelperT.getMonthEndDate(_scheduleMaxDate!);
      _scheduleMinDate = AppointmentHelperT.getMonthStartDate(_scheduleMinDate!);
    ...
    if ((_isNeedLoadMore || _isScheduleStartLoadMore) &&
      ...
      final DateTime visibleStartDate = _isNeedLoadMore
          ? AppointmentHelperT.getMonthStartDate(_scheduleMaxDate!)
          : _scheduleMinDate!;
      final DateTime visibleEndDate = _isNeedLoadMore
          ? _scheduleMaxDate!
          : AppointmentHelperT.getMonthEndDate(_scheduleMinDate!);
  ...
  void _onKeyDown(RawKeyEvent event) {
    ...
    CalendarViewHelperT.handleViewSwitchKeyBoardEvent(
  ...
  Widget _getCalendarViewPopup() {
    ...
    int selectedIndex = -1;
    final Color? todayColor = CalendarViewHelperT.getTodayHighlightTextColor(
        widget.todayHighlightColor ?? _calendarTheme.todayHighlightColor,
        widget.todayTextStyle,
        _calendarTheme);

    final Map<CalendarViewT, String> calendarViews =
    ...
    for (int i = 0; i < allowedViewLength; i++) {
      final CalendarViewT view = widget.allowedViews![i];
    ...
    final bool navigationArrowEnabled =
        widget.showNavigationArrow && _view != CalendarViewT.schedule;
  ...
  Widget _addResourcePanel(bool isResourceEnabled, double resourceViewSize,
    ...
    final double viewHeaderHeight =
    CalendarViewHelperT.getViewHeaderHeight(widget.viewHeaderHeight, _view);
    final double timeLabelSize = CalendarViewHelperT.getTimeLabelWidth(
        widget.timeSlotViewSettings.timeRulerSize, _view);
    final double top = viewHeaderHeight + timeLabelSize;
    final double resourceItemHeight = CalendarViewHelperT.getResourceItemHeight(
        resourceViewSize,
        height - top,
        widget.resourceViewSettings,
        _resourceCollection!.length);
    ...
    return Positioned(
        ...
        child: Stack(children: <Widget>[
          Positioned(
            ...
            width: 0.5,
            top: _controller.view == CalendarViewT.timelineMonth
                ? widget.headerHeight
                : widget.headerHeight + viewHeaderHeight,
            height: _controller.view == CalendarViewT.timelineMonth
                ? viewHeaderHeight
                : timeLabelSize,
  ...
  void _handleOnLongPressForResourcePanel(
    ...
    final CalendarResourceT tappedResource =
    _getTappedResource(details.localPosition.dy, resourceItemHeight);
    final List<dynamic> resourceAppointments =
    _getSelectedResourceAppointments(tappedResource);
    CalendarViewHelperT.raiseCalendarLongPressCallback(widget, null,
        resourceAppointments, CalendarElementT.resourceHeader, tappedResource);
  }
  ...
  void _handleOnTapForResourcePanel(
    ...
    if (!CalendarViewHelperT.shouldRaiseCalendarTapCallback(widget.onTap)) {
      return;
    }
    ...
    final List<dynamic> resourceAppointments =
    _getSelectedResourceAppointments(tappedResource);
    CalendarViewHelperT.raiseCalendarTapCallback(widget, null,
        resourceAppointments, CalendarElementT.resourceHeader, tappedResource);
  }

  /// Filter and returns the appointment collection for the given resource from
  /// the visible appointments collection.
  List<dynamic> _getSelectedResourceAppointments(CalendarResourceT resource) {
  ...
  CalendarResourceT _getTappedResource(
  ...
  Widget _addCustomScrollView(
    ...
    return Positioned(
      ...
      child: _OpacityWidgetT(
          opacity: _opacity,
          child: CustomCalendarScrollViewT(
            widget,
            _view,
            width - resourceViewSize,
            height - agendaHeight,
  ...
  Widget _addDatePicker(double top, bool isRTL) {
    ...
    final Color? todayColor =
        widget.todayHighlightColor ?? _calendarTheme.todayHighlightColor;
    final Color? todayTextColor = CalendarViewHelperT.getTodayHighlightTextColor(
        ...
        child: _PopupWidget(
            child: Container(
                ...
                child: SfDateRangePicker(
                  ...
                  selectableDayPredicate: _view != CalendarViewT.workWeek &&
                      _view != CalendarViewT.timelineWorkWeek
                      ? null
                      : (DateTime dateTime) {
                    for (int i = 0;
                  ...
                  view: _view == CalendarViewT.month ||
                      _view == CalendarViewT.timelineMonth
  ...
  void _getCalendarStateDetails(UpdateCalendarStateDetailsT details) {
  ...
  void _updateCalendarState(UpdateCalendarStateDetailsT details) {
    ...
    if (_currentViewVisibleDates != details.currentViewVisibleDates) {
      ...
      _allDayAppointmentViewCollection = <AppointmentViewT>[];
      _visibleAppointments = <CalendarAppointmentT>[];
      _allDayPanelHeight = 0;
      ...
      if (CalendarViewHelperT.shouldRaiseViewChangedCallback(
        ...
        if (!showTrailingLeadingDates) {
          visibleDates = DateTimeHelperT.getCurrentMonthDates(visibleDates);
        }

        CalendarViewHelperT.raiseViewChangedCallback(widget, visibleDates);
      }
    }
  ...
  void _handleOnTapForHeader(double width) {
    ...
    CalendarViewHelperT.raiseCalendarTapCallback(
        widget, _getTappedHeaderDate(), null, CalendarElementT.header, null);
  }
  ...
  List<dynamic> _getSelectedAppointments(
    ...
    List<CalendarAppointmentT> agendaAppointments =
    ...
    for (int i = 0; i < agendaAppointments.length; i++) {
      final CalendarAppointmentT appointment = agendaAppointments[i];
    ...
    agendaAppointments = <CalendarAppointmentT>[agendaAppointments[index]];
    if (widget.dataSource != null &&
        !AppointmentHelperT.isCalendarAppointment(widget.dataSource!)) {
      return CalendarViewHelperT.getCustomAppointments(
  ...
  Widget _addAgendaView(
    ...
    final List<CalendarAppointmentT> agendaAppointments =
    AppointmentHelperT.getSelectedDateAppointments(
...
class _OpacityWidgetT extends StatefulWidget {
  const _OpacityWidgetT({required this.child, required this.opacity});
...
class _OpacityWidgetState extends State<_OpacityWidgetT> {
  @override
  void initState() {
  ...
  @override
  void didUpdateWidget(covariant _OpacityWidgetT oldWidget) {
...
@immutable
class _CalendarHeaderViewT extends StatefulWidget {
  const _CalendarHeaderViewT(
      this.visibleDates,
      this.headerStyle,
      this.currentDate,
      this.view,
  ...
  final List<CalendarViewT>? allowedViews;
  final bool allowViewNavigation;
  final MonthNavigationDirectionT navigationDirection;
  ...
  final bool showDatePickerButton;
  final SfLocalizationsT localizations;
...
class _CalendarHeaderViewState extends State<_CalendarHeaderViewT> {
  late Map<CalendarViewT, String> _calendarViews;
  ...
  @override
  void didUpdateWidget(_CalendarHeaderViewT oldWidget) {
  ...
  @override
  Widget build(BuildContext context) {
    final bool useMobilePlatformUI = CalendarViewHelperT.isMobileLayoutUI(
    ...
    /// not have a support for navigation arrow.
    final bool navigationArrowEnabled =
        widget.showNavigationArrow && widget.view != CalendarViewT.schedule;
    ...
    final bool isTimelineView = CalendarViewHelperT.isTimelineView(widget.view);
    ...
    final bool weekNumberEnabled = widget.showWeekNumber &&
        (widget.view == CalendarViewT.day || isTimelineView);
    ...
    final Color? highlightColor = CalendarViewHelperT.getTodayHighlightTextColor(
    ...
    if (isNeedViewSwitchOption) {
      ...
      if (useMobilePlatformUI) {
        ...
        final Map<CalendarViewT, double> calendarViewsWidth =
        <CalendarViewT, double>{};
        ...
        for (int i = 0; i < allowedViewsLength; i++) {
          final CalendarViewT currentView = widget.allowedViews![i];
    ...
    if (!DateTimeHelperT.canMoveToNextView(
        widget.view,
    ...
    if (!DateTimeHelperT.canMoveToPreviousView(
        widget.view,
        widget.numberOfWeeksInView,
        widget.minDate,
        widget.maxDate,
              ...
              child: Container(
                  ...
                  child: Icon(
                    widget.navigationDirection ==
                        MonthNavigationDirectionT.horizontal
                        ? Icons.chevron_left
  ...
  String _getWeekNumberString() {
    switch (widget.view) {
      ...
      case CalendarViewT.timelineDay:
        {
          return DateTimeHelperT.getWeekNumberOfYear(widget.visibleDates[0])
              .toString();
        }
      case CalendarViewT.week:
      case CalendarViewT.workWeek:
      ...
      case CalendarViewT.timelineWeek:
        for (int i = 0; i < widget.visibleDates.length; i++) {
          ...
          if (date.weekday == DateTime.monday) {
            return DateTimeHelperT.getWeekNumberOfYear(date).toString();
          }
        }
        break;
      case CalendarViewT.timelineWorkWeek:
        for (int i = 0; i < widget.visibleDates.length; i++) {
          ...
          if (date.weekday == DateTime.monday) {
            ...
            return DateTimeHelperT.getWeekNumberOfYear(
...
class _ScheduleLabelPainter extends CustomPainter {
  ...
  final String locale;
  final ScheduleViewSettingsT scheduleViewSettings;
  final SfLocalizationsT _localizations;
  final bool useMobilePlatformUI;
  final ValueNotifier<ScheduleViewHoveringDetailsT?> agendaViewNotifier;
  final SfCalendarThemeDataT calendarTheme;
...
class _AgendaDateTimePainterT extends CustomPainter {
  _AgendaDateTimePainterT(
      this.selectedDate,
  ...
  final TextStyle? todayTextStyle;
  final String locale;
  final ValueNotifier<ScheduleViewHoveringDetailsT?> agendaDateNotifier;
  final SfCalendarThemeDataT calendarTheme;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final bool useMobilePlatformUI =
    CalendarViewHelperT.isMobileLayoutUI(viewWidth, isMobilePlatform);
    ...
    if (isToday) {
      ...
      CalendarViewHelperT.getTodayHighlightTextColor(
    ...
    if (scheduleViewSettings == null || useMobilePlatformUI) {
      _addDayLabelForMobile(canvas, size, padding, dayTextStyle!,
          dateTextStyle!, isToday, isMobilePlatform);
    } else {
      _addDayLabelForWeb(
...
Map<CalendarViewT, String> _getCalendarViewsText(SfLocalizationsT localizations) {
  final Map<CalendarViewT, String> calendarViews = <CalendarViewT, String>{};
  calendarViews[CalendarViewT.day] = localizations.allowedViewDayLabel;
  calendarViews[CalendarViewT.week] = localizations.allowedViewWeekLabel;
  calendarViews[CalendarViewT.workWeek] = localizations.allowedViewWorkWeekLabel;
  calendarViews[CalendarViewT.timelineDay] =
      localizations.allowedViewTimelineDayLabel;
  calendarViews[CalendarViewT.timelineWeek] =
      localizations.allowedViewTimelineWeekLabel;
  calendarViews[CalendarViewT.timelineMonth] =
      localizations.allowedViewTimelineMonthLabel;
  calendarViews[CalendarViewT.timelineWorkWeek] =
      localizations.allowedViewTimelineWorkWeekLabel;
  calendarViews[CalendarViewT.month] = localizations.allowedViewMonthLabel;
  calendarViews[CalendarViewT.schedule] = localizations.allowedViewScheduleLabel;
  return calendarViews;
}

/// Return day label width based on schedule view setting.
double _getAgendaViewDayLabelWidth(
    ScheduleViewSettingsT scheduleViewSettings, bool useMobilePlatformUI) {
