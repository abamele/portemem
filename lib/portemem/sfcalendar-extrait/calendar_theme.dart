...
/// }
/// ```
class SfCalendarThemeT extends InheritedTheme {
  /// Constructor for the calendar theme class, which applies a theme to
  /// descendant Syncfusion calendar widgets.
  const SfCalendarThemeT({Key? key, required this.data, required this.child})
  ...
  /// }
  /// ```
  final SfCalendarThemeDataT data;
  ...
  static SfCalendarThemeDataT of(BuildContext context) {
    final SfCalendarThemeT? sfCalendarTheme =
    context.dependOnInheritedWidgetOfExactType<SfCalendarThemeT>();
    return sfCalendarTheme?.data ?? SfThemeT.of(context).calendarThemeData;
  }

  @override
  bool updateShouldNotify(SfCalendarThemeT oldWidget) => data != oldWidget.data;

  @override
  Widget wrap(BuildContext context, Widget child) {
    final SfCalendarThemeT? ancestorTheme =
    context.findAncestorWidgetOfExactType<SfCalendarThemeT>();
    return identical(this, ancestorTheme)
        ? child
        : SfCalendarThemeT(data: data, child: child);
  }
}
...
/// ```
@immutable
class SfCalendarThemeDataT with Diagnosticable {
  /// Create a [SfCalendarThemeData] that's used to configure a
  /// [SfCalendarTheme].
  factory SfCalendarThemeDataT({
    ...
    return SfCalendarThemeDataT.raw(
        brightness: brightness,
  ...
  const SfCalendarThemeDataT.raw(
  ...
  static SfCalendarThemeDataT? lerp(
      SfCalendarThemeDataT? a, SfCalendarThemeDataT? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    return SfCalendarThemeDataT(
  ...
  bool operator ==(Object other) {
    ...
    return other is SfCalendarThemeDataT &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    final SfCalendarThemeDataT defaultData = SfCalendarThemeDataT();
