...
///
class SfChartThemeT extends InheritedTheme {
  /// Creating an argument constructor of SfChartTheme class.
  const SfChartThemeT({Key? key, required this.data, required this.child})
  ...
  ///
  static SfChartThemeDataT of(BuildContext context) {
    final SfChartThemeT? sfChartTheme =
    context.dependOnInheritedWidgetOfExactType<SfChartThemeT>();
    return sfChartTheme?.data ?? SfThemeT.of(context).chartThemeData;
  }

  @override
  bool updateShouldNotify(SfChartThemeT oldWidget) => data != oldWidget.data;

  @override
  Widget wrap(BuildContext context, Widget child) {
    final SfChartThemeT? ancestorTheme =
    context.findAncestorWidgetOfExactType<SfChartThemeT>();
    return identical(this, ancestorTheme)
        ? child
        : SfChartThemeT(data: data, child: child);
  }
}
...
///
@immutable
class SfChartThemeDataT with Diagnosticable {
  /// Creating an argument constructor of SfChartThemeData class.
  factory SfChartThemeDataT(
  ...
  static SfChartThemeDataT? lerp(
      SfChartThemeDataT? a, SfChartThemeDataT? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    return SfChartThemeDataT(
  ...
  bool operator ==(Object other) {
    ...
    return other is SfChartThemeDataT &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    final SfChartThemeDataT defaultData = SfChartThemeDataT();
