...
typedef CalendarDetailsCallback = CalendarDetailsT? Function(Offset position);
...
///}
/// ```
class CalendarControllerT extends CalendarValueChangedNotifier {
  ...
  set selectedDate(DateTime? date) {
    if (CalendarViewHelperT.isSameTimeSlot(_selectedDate, date)) {
      return;
    }
