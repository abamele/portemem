...
class WeekNumberStyleT with Diagnosticable {
  ...
  bool operator ==(dynamic other) {
    ...
    late final WeekNumberStyleT otherStyle;
    if (other is WeekNumberStyleT) {
      otherStyle = other;
    }
