...
///
class SfBarcodeThemeT extends InheritedTheme {
  /// Initialize the class of SfBarcodeTheme
  const SfBarcodeThemeT({Key? key, required this.data, required this.child})
  ...
  final SfBarcodeThemeDataT data;
  ...
  static SfBarcodeThemeDataT of(BuildContext context) {
    final SfBarcodeThemeT? sfBarcodeTheme =
    context.dependOnInheritedWidgetOfExactType<SfBarcodeThemeT>();
    return sfBarcodeTheme?.data ?? SfThemeT.of(context).barcodeThemeData;
  }

  @override
  bool updateShouldNotify(SfBarcodeThemeT oldWidget) => data != oldWidget.data;

  @override
  Widget wrap(BuildContext context, Widget child) {
    final SfBarcodeThemeT? ancestorTheme =
    context.findAncestorWidgetOfExactType<SfBarcodeThemeT>();
    return identical(this, ancestorTheme)
        ? child
        : SfBarcodeThemeT(data: data, child: child);
  }
}
...
///
@immutable
class SfBarcodeThemeDataT with Diagnosticable {
  /// Initialize the SfBarcode theme data
  factory SfBarcodeThemeDataT({
    ...
    return SfBarcodeThemeDataT.raw(
        brightness: brightness,
  ...
  static SfBarcodeThemeDataT? lerp(
      SfBarcodeThemeDataT? a, SfBarcodeThemeDataT? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    return SfBarcodeThemeDataT(
  ...
  bool operator ==(Object other) {
    ...
    return other is SfBarcodeThemeDataT &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    final SfBarcodeThemeDataT defaultData = SfBarcodeThemeDataT();
