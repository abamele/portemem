...
/// }
///  ```
class AppointmentT with Diagnosticable {
  ...
  AppointmentTypeT _appointmentType = AppointmentTypeT.normal;
  ...
  ///
  ///  ```
  AppointmentTypeT get appointmentType => _appointmentType;
  ...
  AppointmentTypeT _getAppointmentType() {
    if (recurrenceId != null) {
      return AppointmentTypeT.changedOccurrence;
      ...
      if (notes != null && notes!.contains('isOccurrenceAppointment')) {
        ...
        return AppointmentTypeT.occurrence;
      }

      return AppointmentTypeT.pattern;
    }
    return AppointmentTypeT.normal;
  }
  ...
  bool operator ==(dynamic other) {
    ...
    late final AppointmentT otherStyle;
    if (other is AppointmentT) {
      otherStyle = other;
    }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
        .add(EnumProperty<AppointmentTypeT>('appointmentType', appointmentType));
