...
import 'package:portemem/portemem/sfcalendar-extrait/sfTheme_widget.dart';
...
class SfDateRangePickerThemeT extends InheritedTheme {
  ...
  /// }
  /// ```
  final SfDateRangePickerThemeDataT data;
  ...
  static SfDateRangePickerThemeDataT of(BuildContext context) {
    final SfDateRangePickerThemeT? sfDateRangePickerTheme =
    context.dependOnInheritedWidgetOfExactType<SfDateRangePickerThemeT>();
    return sfDateRangePickerTheme?.data ??
        SfThemeT.of(context).dateRangePickerThemeData;
  }

  @override
  bool updateShouldNotify(SfDateRangePickerThemeT oldWidget) =>
      data != oldWidget.data;

  @override
  Widget wrap(BuildContext context, Widget child) {
    final SfDateRangePickerThemeT? ancestorTheme =
    context.findAncestorWidgetOfExactType<SfDateRangePickerThemeT>();
    return identical(this, ancestorTheme)
        ? child
        : SfDateRangePickerThemeT(data: data, child: child);
  }
}
...
/// ```
@immutable
class SfDateRangePickerThemeDataT with Diagnosticable {
  /// Create a [SfDateRangePickerThemeData] that's used to configure a
  /// [SfDateRangePickerTheme].
  factory SfDateRangePickerThemeDataT({
    ...
    return SfDateRangePickerThemeDataT.raw(
        brightness: brightness,
  ...
  const SfDateRangePickerThemeDataT.raw(
  ...
  SfDateRangePickerThemeDataT copyWith({
    Brightness? brightness,
    TextStyle? viewHeaderTextStyle,
    Color? backgroundColor,
    TextStyle? headerTextStyle,
  ...
  static SfDateRangePickerThemeDataT? lerp(
      SfDateRangePickerThemeDataT? a, SfDateRangePickerThemeDataT? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    return SfDateRangePickerThemeDataT(
  ...
  bool operator ==(Object other) {
    ...
    return other is SfDateRangePickerThemeDataT &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    final SfDateRangePickerThemeDataT defaultData = SfDateRangePickerThemeDataT();
