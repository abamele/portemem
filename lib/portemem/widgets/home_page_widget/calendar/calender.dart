...
import 'package:portemem/portemem/widgets/home_page_widget/calendar/simple_gesture_detector.dart';
import 'package:portemem/portemem/widgets/home_page_widget/initialize_date_formatting_widget.dart';
import 'package:portemem/portemem/widgets/home_page_widget/utils_widget.dart';
import '../calender_tile.dart';
import "package:intl/intl.dart";
import '../clean_calender_event.dart';

// Export NeatCleanCalendarEvent for using it in the application


typedef DayBuilder(BuildContext context, DateTime day);
typedef EventListBuilder(BuildContext context, List<CleanCalendarEventT> events);
...
class CalendarT extends StatefulWidget {
  ...
  final ValueChanged<CleanCalendarEventT>? onEventSelected;
  final bool isExpandable;
  final DayBuilder? dayBuilder;
  final EventListBuilder? eventListBuilder;
  final bool hideArrows;
  final bool hideTodayIcon;
  final Map<DateTime, List<CleanCalendarEventT>>? events;
...
class _CalendarState extends State<CalendarT> {
  ...
  List<CleanCalendarEventT>? _selectedEvents;
      ...
      return Expanded(
        child: _selectedEvents != null && _selectedEvents!.isNotEmpty
          ...
          itemBuilder: (BuildContext context, int index) {
            final CleanCalendarEventT event = _selectedEvents![index];
            final String start =
