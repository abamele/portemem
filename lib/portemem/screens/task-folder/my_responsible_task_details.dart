...
class MyResponsibleTaskDetails extends StatefulWidget {
  Map taskList;
  MyResponsibleTaskDetails({
    Key? key,
    required this.taskList,
  }) : super(key: key);

  @override
  State<MyResponsibleTaskDetails> createState() => _MyResponsibleTaskDetailsState();
}

class _MyResponsibleTaskDetailsState extends State<MyResponsibleTaskDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    String _taskResp = widget.taskList["GorevSorumlusu"] ?? '';
