...
class _TaskDetailsState extends State<TaskDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    //String _taskType = widget.taskList["GorevTipi"] ?? '';
    String _taskStartDate = widget.taskList["GorevBaslangicFormatli"] ?? '';
    String _taskEndDate = widget.taskList["GorevBitisFormatli"] ?? '';
    ...
    List _taskResp = widget.taskList["GorevSorumlusuListeText"] ?? '';
